...
<head>
    <base href="">
    <meta charset="utf-8"/>
    <title>Збірник | Админ-панель</title>
            ...
            <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                ...
                <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item {{ request()->routeIs('admin.criminal_articles.index') ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
                            <a href="{{route('admin.criminal_articles.index')}}" class="menu-link">
                                <i class="fas fa-pen menu-icon"></i>
                        ...
                        <li class="menu-item {{ request()->routeIs('admin.favourites.index') ? 'menu-item-active' : '' }}"
                            ...
                            <a href="{{route('admin.favourites.index')}}" class="menu-link">
                                ...
                                <span class="menu-text">Закладки</span>
                            </a>
                        </li>
                        <li class="menu-item {{ request()->routeIs('admin.file_manager.index') ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
                            <a href="{{route('admin.file_manager.index')}}" class="menu-link">
...
{{--                                <i class="flaticon-folder menu-icon"></i>--}}
{{--                                <span class="menu-text">Підписки</span>--}}
{{--                            </a>--}}
{{--                        </li>--}}
...
<i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                        ...
                        <li class="menu-item  menu-item-submenu {{ (request()->routeIs(['admin.system-pages.*'])) ? 'menu-item-open' : '' }}"
                            aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                <i class="flaticon-folder menu-icon"></i>
                                <span class="menu-text">Системні сторінки</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    <li class="menu-item  menu-item-parent" aria-haspopup="true">
                                        <span class="menu-link"><span class="menu-text">Системні сторінки</span></span>
                                    </li>
...
<h3 class="font-weight-bold m-0">Ваш профіль</h3>
