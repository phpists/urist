        ...
        <div class="topbar">
            ...
            <div class="topbar-item">
                <a target="_blank" href="{{ route('home') }}"
                   class="btn btn-sm btn-light-primary font-weight-bolder">Відкрити сайт</a>
            </div>
            <!--begin::User-->
            <div class="topbar-item">
                <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"
                     id="kt_quick_user_toggle">
                    <span class="text-muted font-weight-bold font-size-base d-none d-md-inline mr-1">Привіт, {{Auth::user()->name}}</span>
                    <span
