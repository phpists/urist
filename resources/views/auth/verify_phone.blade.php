...
@section('page')
    <div class="login-section">
        <div class="login-section__inner">
            <form class="form" id="code-form" autocomplete="off" action="{{route('verify_phone')}}" method="POST" novalidate="novalidate">
            @csrf
            @method('POST')
            ...
            <div class="form__group" @error('code') style="margin-top: 30px;" @enderror>
                <div class="form__info" id="resendVerificationBlock" data-url="{{ route('auth.verify-phone.resend') }}">Не отримали код? <a class="blue-link" href="#" data-modal="login-modal">Відправити ще раз</a></div>
            </div>
