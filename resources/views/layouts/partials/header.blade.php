    ...
    <div class="container header__container">
        <div class="logo header__logo">
            <a class="logo__link" href="/" aria-label="logo">
                <img class="logo__img" src="{{ asset('/assets/img/logo.png') }}"
                     srcset="{{ asset('assets/img/logo@2x.png') }} 2x" width="101" height="73" alt="logo"/>
            </a>
        </div>

        <nav class="menu header__menu">
            <ul class="menu__list">
                <li class="menu__item"><a class="menu__link @if(request()->routeIs('home')) is-active @endif"
                                          href="/#tariffs-section">Тарифи</a></li>
                <li class="menu__item"><a class="menu__link @if(request()->routeIs('blog.*')) is-active @endif"
                                          href="{{ route('blog.index') }}">Блог</a></li>
                <li class="menu__item"><a class="menu__link @if(request()->routeIs('faq')) is-active @endif"
                                          href="{{ route('faq') }}">FAQ</a></li>
                <li class="menu__item"><a class="menu__link @if(request()->routeIs('contacts')) is-active @endif"
                                          href="{{ route('contacts') }}">Контакти</a></li>
                <li class="menu__item"><a class="menu__link @if(request()->routeIs('about')) is-active @endif"
                                          href="{{ route('about') }}" style="white-space: nowrap;">Про нас</a></li>
            </ul>
        </nav>
        <ul class="actions">
            @guest
            ...
            <li class="actions__item actions__item--hidden-md">
                <a class="button button--app actions__button"
                   href="{{ get_setting_value_by_name(\App\Enums\SettingEnum::APPLE_STORE_URL) }}">
            ...
            <li class="actions__item actions__item--hidden-md">
                <a class="button button--app actions__button"
                   href="{{ get_setting_value_by_name(\App\Enums\SettingEnum::GOOGLE_STORE_URL) }}">
            ...
            <li class="actions__item">
                <a class="button button--square button--outline actions__button" href="#" data-modal="modal-social">
                    <svg class="button__icon" width="16" height="17">
                        <use xlink:href="{{ asset('assets/img/sprite.svg#share') }}"></use>
                    </svg>
                </a>
            </li>
            <li class="actions__item">
                <a class="button button--square button--facebook actions__button" href="{{ get_setting_value_by_name(\App\Enums\SettingEnum::FACEBOOK_URL) }}" target="_blank">
                    <svg class="button__icon" width="9" height="18">
                        <use xlink:href="{{ asset('assets/img/sprite.svg#facebook') }}"></use>
                    </svg>
                </a>
            </li>
            <li class="actions__item actions__item--hidden-lg">
                <div class="qr-code">
                    <img class="qr-code__img" src="{{ asset('assets/img/qr-code.webp') }}"
                         srcset="{{ asset('assets/img/qr-code@2x.webp') }} 2x"
                         loading="lazy" width="62" height="60" alt="alt"/>
                </div>
            </li>
            <li class="actions__item actions__item--visible-lg">
