    ...
    <div class="container profile-section__container">
        ...
        <form action="{{ route('user.profile.update') }}" method="POST" class="form profile-section__form" id="profile-form" autocomplete="off" novalidate="novalidate">
            ...
            <div class="form-block">
                ...
                <div class="form-block__right">
                    <input class="input form__input phone-mask" id="inputPhone" type="text" name="phone" placeholder="+38 (___) __-__-___" autocomplete="off" value="{{ old('phone', Str::substr($user->phone, 2)) }}" required="required"/>
                </div>
            </div>
            <div class="form-block">
                <div class="form-block__left">
